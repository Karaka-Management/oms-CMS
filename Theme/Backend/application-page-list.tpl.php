...
$previous = empty($list) ? '{/base}/cms/application/page?{?}' : '{/base}/cms/application/page?{?}&offset=' . \reset($list)->id . '&ptype=p';
$next     = empty($list) ? '{/base}/cms/application/page?{?}' : '{/base}/cms/application/page?{?}&offset=' . \end($list)->id . '&ptype=n';
