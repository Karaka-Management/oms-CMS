...
$previous = empty($list) ? '{/base}/cms/application/post?{?}' : '{/base}/cms/application/post?{?}&id=' . \reset($list)->id . '&ptype=p';
$next     = empty($list) ? '{/base}/cms/application/post?{?}' : '{/base}/cms/application/post?{?}&id=' . \end($list)->id . '&ptype=n';
